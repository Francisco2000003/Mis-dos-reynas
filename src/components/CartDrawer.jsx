...
export default function CartDrawer({ open, onClose }) {
  ...
  const handleContinue = () => {
    ...
    navigate("/checkout");  // manda al checkout
    // opcional: sube arriba (útil si vienes desde abajo)
    window.scrollTo({ top: 0, behavior: "smooth" });
  };

  return (
    <>
      {/* overlay (subimos z-index) */}
      <div
        className={[
      ...
      >
        ...
        <div className="border-t p-5">
          ...
          <p className="mt-3 text-xs text-gray-500">
            Envío y pagos los metemos después (paso a paso).
          </p>
        </div>
      </aside>
    </>
