  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-14">
      ...
      <p className="mt-6 text-base text-gray-700">
        ¿No te quedó o no te gustó? Aquí están las políticas e instrucciones para hacer cambios
        de talla, elegir otra prenda o recibir un saldo a favor.
      </p>

      <h2 className="mt-12 text-2xl font-extrabold">Políticas de cambios</h2>
      <ul className="mt-4 list-disc pl-6 space-y-2 text-gray-700">
        <li>No hacemos devoluciones de dinero; únicamente cambios por talla o por otro artículo.</li>
